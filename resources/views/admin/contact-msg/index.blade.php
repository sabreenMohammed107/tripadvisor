    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Contact Msg</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Contact Msg</li>
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
                       ...
                       <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-200px">Message</th>
     ...
     <tr>
        ...
        <td class="text-end pe-0" data-order="15">
            ...
            <span class="fw-bolder ms-3">{{ $row->phone ??'' }}</span>
        </td>
        <!--end::Qty=-->
        <!--begin::Price=-->
        <td class="text-end pe-0" data-order="15">
        ...
        <!--end::Price=-->
        {{-- <td class="text-end pe-0" data-order="15">
            <span class="fw-bolder ms-3">{{ $row->subject ??'' }}</span>
        </td> --}}
        <!--begin::Action=-->
        <td class="text-end pe-0" data-order="15">
            <span class="fw-bolder ms-3">{{ $row->message ??'' }}</span>
        </td>
