    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
                       ...
                       <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-70px">trip_brief</th>
                                <th class="text-end min-w-100px">trip_date</th>
     ...
     <tr>
        ...
        <td class="text-end pe-0" data-order="15">
            ...
            <span class="fw-bolder ms-3">{{ $row->trip_brief ??'' }}</span>
        </td>
        <!--end::Qty=-->
        <!--begin::Price=-->
        <td class="text-end pe-0">
            <span class="fw-bolder text-dark">{{ $row->trip_date }}</span>
        </td>
        <!--end::Price=-->
        <td class="text-end pe-0">
        ...
        <td class="text-end">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                ...
                <div class="menu-item px-3">
                    <a href="{{ route('trips.edit', $row->id) }}"
        ...
        <form id="delete_{{$row->id}}" action="{{ route('trips.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
