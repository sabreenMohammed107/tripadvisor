...
@section('content')
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
            ...
            action="{{ route('trips.update', $row->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                <!--begin::Aside column-->
    ...
    <div class="card-body text-center pt-0">
       ...
       <div class="card-body text-center pt-0">
        ...
        <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true"
            style="background-image: url('{{ asset('uploads/trips') }}/{{ $row->banner }}')">
...
<!--end::Thumbnail settings-->
 ...
 <div class="mb-10 fv-row">
    ...
    <input class="form-control  form-control-solid dPick" name="trip_date"
        value="{{ $row->trip_date }}" placeholder="Pick date" id="kt_datepicker_3" />
