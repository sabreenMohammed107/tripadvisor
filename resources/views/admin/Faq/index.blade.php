    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
                       ...
                       <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-70px">answer</th>
     ...
     <tr>
        ...
        <td>
            <div class="d-flex align-items-center">
                ...
                <div class="ms-5">
                    ...
                    data-kt-ecommerce-category-filter="category_name" >{{ $row->question}}</a>
                    <!--end::Title-->
                </div>
            </div>
        </td>
        ...
        <td class="text-end pe-0" data-order="15">
            ...
            <span class="fw-bolder ms-3">{{ $row->answer ??'' }}</span>
        </td>
        <!--end::Qty=-->
        <!--begin::Price=-->
        ...
        <form id="delete_{{$row->id}}" action="{{ route('faq.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
